<template>
    <default-field :field="field" :errors="errors">
        <template slot="field">
            <input :id="field.name" type="text" ref="input"
    ...
    export default {
        ...
        methods: {
            ...
            setBuiltInMasks() {
                ...
                let masks = !countries.length
                    ? PhoneMasks
                    : this.loadMasksForCountries(countries)
            ...
            /**
             * Format strings to follow Inputmask rules
             */
            formatToInputmask(value) {
                return value
                    ? value.replace(/9/gi, '\\9').replace(/#/gi, '9')
                    : ''
            },
